...
import com.runningwith.modules.users.form.*;
import com.runningwith.modules.users.validator.NicknameFormValidator;
import com.runningwith.modules.users.validator.PasswordFormValidator;
...
public class SettingsController {
    ...
    public String profileUpdateView(@CurrentUser UsersEntity usersEntity, Model model) {
        ...
        model.addAttribute("profile", Profile.toProfile(usersEntity));
